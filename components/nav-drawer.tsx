  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-0 z-50 pointer-events-none">
          <Dialog.Title className="sr-only">{t("nav.menu")}</Dialog.Title>
          <div className="h-full max-w-2xl mx-auto relative pointer-events-none">
            <div className="absolute left-0 top-0 h-full w-72 bg-white shadow-xl flex flex-col pointer-events-auto">
