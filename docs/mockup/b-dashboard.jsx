  ...
  return (
    <div style={{ padding: "18px 16px 0" }}>
      ...
      >
        ...
        <ReceiptRow
          label={lang === "nl" ? "Jouw ritten" : "Your trips"}
          value={"− " + fmtMoney(s.tripsCost)}
        />
        <ReceiptRow
          label={lang === "nl" ? "Jouw tankbeurten" : "Your fuel paid"}
          value={fmtMoney(s.fuelPaid)}
        />
        <ReceiptRow
          label={lang === "nl" ? "Jouw onderhoud" : "Your maintenance"}
          value={fmtMoney(s.expPaid)}
        />
        ...
        >
          ...
          >
            {positive ? "+ " : "− "}
            {fmtMoney(Math.abs(s.balance)).replace("€ ", "€ ")}
          </div>
        </div>
