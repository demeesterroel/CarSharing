...
const strings = {
  nl: {
    ...
    tabRitten: "Ritten",
    tabTanken: "Tanken",
    tabReserve: "Reserveren",
    tabKosten: "Kosten",
    tabBack: "Terug",
    // dashboard
    greeting: "Hallo, Roeland",
    today: "Vandaag",
    balance: "Jaarsaldo",
    youGet: "Je krijgt",
    youOwe: "Te betalen",
    recentTrips: "Recente ritten",
    recentFuel: "Recente tankbeurten",
    upcoming: "Komende reserveringen",
    seeAll: "Alles zien",
    newTrip: "Nieuwe rit",
    newFuel: "Nieuwe tankbeurt",
    newExpense: "Extra kost",
    newReserve: "Reserveren",
    reserve: "Reserveren",
    // form labels
    wagen: "Wagen",
    ...
    afstand: "Afstand",
    tarief: "Tarief",
    parkingLoc: "Parking locatie",
    gpsAuto: "GPS herkend",
    kortingBasis: "Korting (≤500 km)",
    kortingLang: "Korting lange rit (>500 km)",
    tariefBase: "Basis tarief",
    lange: "Lange rit toeslag",
    geenKorting: "Geen korting",
    totaal: "Totaal",
    betaaldDoor: "Betaald door",
    bedrag: "Bedrag",
    liters: "Liters",
    prijsL: "Prijs per liter",
    station: "Tankstation",
    volleTank: "Volle tank?",
    kilostand: "Kilometerstand",
    kilostandVereist: "Vereist bij volle tank — zo berekenen we het verbruik",
    reden: "Reden (optioneel)",
    van: "Van",
    tot: "Tot",
    // actions
    opslaan: "Opslaan",
    ritOpslaan: "Rit opslaan",
    tankOpslaan: "Tankbon opslaan",
    kostOpslaan: "Kost opslaan",
    reserveOpslaan: "Reservering bevestigen",
    annuleer: "Annuleren",
    bewaard: "Bewaard",
    veegOmlaag: "≋ Trek omlaag om op te slaan ≋",
    laatLos: "↓ Laat los om af te scheuren ↓",
    eerlijkGedeeld: "Eerlijk gedeeld",
    inDeKas: "In de kas",
    // units
    trips: "ritten",
    tripsThisYear: "ritten dit jaar",
    km: "km",
    fillups: "tankbeurten",
    liter: "liter",
    days: "dagen",
    ...
    tabBeheer: "Beheer",
    beheer: "Beheer",
    beheerSub: "Co-op administratie",
    beheerInbox: "Te bevestigen",
    beheerMembers: "Leden",
    beheerHygiene: "Data-hygiëne",
    beheerSettle: "Afrekening",
    beheerPayout: "Uitbetaling",
    beheerFleet: "Vloot",
    beheerWagens: "Wagens",
    beheerPersonen: "Personen",
    beheerBetalingen: "Betalingen",
    inboxEmpty: "Niets te bevestigen",
    approve: "Bevestigen",
    reject: "Weigeren",
    mailPreview: "Mail naar aanvrager",
    daysAgo: "d geleden",
    kmPrice: "Km-prijs",
    kmPriceHelper: "Km-prijs assistent",
    longThreshold: "LONG-drempel",
    fixedYearCosts: "Vaste jaarkosten",
    variableCosts: "Variabele kosten",
    perKm: "/ km",
    costPrice: "Kostprijs",
    currentPrice: "Huidige prijs",
    suggestionShort: "Advies",
    suggestionSurplus: "Overschot",
    suggestionShortfall: "Tekort",
    scenarioSlider: "Scenario: als je dit vraagt…",
    breakdown: "Opbouw",
    yearTotal: "Jaartotaal",
    brandstof: "Brandstof",
    onderhoudBkd: "Onderhoud",
    verzekeringBkd: "Verzekering",
    belastingBkd: "Belasting",
    keuringBkd: "Keuring",
    afschrijvingBkd: "Afschrijving",
    editCar: "Wagen bewerken",
    saveCar: "Opslaan",
    broekScheuren: "Eigenaar scheurt zijn broek niet",
    broekScheurenWarn: "LET OP: eigenaar legt zelf bij",
    membersDiscounts: "Kortingen",
    baseDiscount: "Basis-korting (≤500 km)",
    longDiscountPct: "Lange-rit korting (>500 km)",
    hasDiscount: "Heeft korting",
    noDiscountShort: "Volle prijs",
    kmGaps: "Gaten in kilometerstand",
    fuelSuspect: "Verdachte tankbeurten",
    assignToMember: "Toewijzen aan lid",
    assignGhost: "Coöperatief (geen bestuurder)",
    splitFuel: "Splitsen in meerdere tankbeurten",
    missing: "ontbreekt",
    suspect: "verdacht",
    settlement: "Jaarafrekening 2026",
    runSettlement: "Afrekening genereren",
    payBack: "Terug te betalen",
    toPay: "Bij te betalen",
    paysZero: "Quitte",
    totalCredits: "Totaal credits",
    totalDebits: "Totaal debits",
    mustBalance: "Moet nul zijn",
    copyInstructions: "Betaalinstructies kopiëren",
    payouts: "Eigenaar-uitbetaling",
    payoutSub: "Na afrekening van alle leden",
    carRevenue: "Rit-opbrengst",
    carFuel: "Brandstof",
    carMaint: "Onderhoud",
    carFixed: "Vaste kosten",
    ownerNet: "Netto naar eigenaar",
    exportCsv: "CSV exporteren",
    exportPdf: "PDF",
    asPaid: "Gemarkeerd als betaald",
  ...
  en: {
    ...
    tabKosten: "Costs",
    tabBack: "Back",
    greeting: "Hello, Roeland",
    today: "Today",
    balance: "Year balance",
    youGet: "You receive",
    youOwe: "You owe",
    recentTrips: "Recent trips",
    recentFuel: "Recent fill-ups",
    ...
    afstand: "Distance",
    tarief: "Rate",
    parkingLoc: "Parking location",
    gpsAuto: "GPS detected",
    kortingBasis: "Discount (≤500 km)",
    kortingLang: "Long-trip discount (>500 km)",
    tariefBase: "Base rate",
    lange: "Long-trip portion",
    geenKorting: "No discount",
    totaal: "Total",
    betaaldDoor: "Paid by",
    bedrag: "Amount",
    liters: "Litres",
    prijsL: "Price per litre",
    station: "Fuel station",
    volleTank: "Full tank?",
    kilostand: "Odometer",
    kilostandVereist: "Required if full tank — so we can compute consumption",
    reden: "Reason (optional)",
    van: "From",
    tot: "To",
    opslaan: "Save",
    ritOpslaan: "Save trip",
    tankOpslaan: "Save receipt",
    kostOpslaan: "Save cost",
    reserveOpslaan: "Confirm reservation",
    annuleer: "Cancel",
    bewaard: "Saved",
    veegOmlaag: "≋ Pull down to save ≋",
    laatLos: "↓ Release to tear off ↓",
    eerlijkGedeeld: "Fairly shared",
    inDeKas: "In the fund",
    trips: "trips",
    ...
    day: "day",
    allTrips: "All trips",
    allFuel: "All fill-ups",
    reservations: "Reservations",
    extraKosten: "Extra costs",
    filterAll: "All",
    filterMine: "Mine",
    perCar: "Per car",
    ...
    tabBeheer: "Admin",
    beheer: "Admin",
    beheerSub: "Co-op administration",
    beheerInbox: "To approve",
    beheerMembers: "Members",
    beheerHygiene: "Data hygiene",
    beheerSettle: "Settlement",
    beheerPayout: "Payout",
    beheerFleet: "Fleet",
    beheerWagens: "Cars",
    beheerPersonen: "People",
    beheerBetalingen: "Payments",
    inboxEmpty: "Nothing to approve",
    approve: "Approve",
    reject: "Reject",
    mailPreview: "Mail to requester",
    daysAgo: "d ago",
    kmPrice: "Km rate",
    kmPriceHelper: "Km-rate assistant",
    longThreshold: "Long threshold",
    fixedYearCosts: "Fixed yearly costs",
    variableCosts: "Variable costs",
    perKm: "/ km",
    costPrice: "Cost price",
    currentPrice: "Current price",
    suggestionShort: "Advice",
    suggestionSurplus: "Surplus",
    suggestionShortfall: "Shortfall",
    scenarioSlider: "Scenario: if you charge…",
    breakdown: "Breakdown",
    yearTotal: "Year total",
    brandstof: "Fuel",
    onderhoudBkd: "Maintenance",
    verzekeringBkd: "Insurance",
    belastingBkd: "Tax",
    keuringBkd: "Inspection",
    afschrijvingBkd: "Depreciation",
    editCar: "Edit car",
    saveCar: "Save",
    broekScheuren: "Owner isn't losing money",
    broekScheurenWarn: "WARNING: owner subsidising",
    membersDiscounts: "Discounts",
    baseDiscount: "Base discount (≤500 km)",
    longDiscountPct: "Long-trip discount (>500 km)",
    hasDiscount: "Has discount",
    noDiscountShort: "Full price",
    kmGaps: "Odometer gaps",
    fuelSuspect: "Suspicious fuel fills",
    assignToMember: "Assign to member",
    assignGhost: "Co-op (no driver)",
    ...
    mustBalance: "Must be zero",
    copyInstructions: "Copy payment instructions",
    payouts: "Owner payout",
    payoutSub: "After members settle up",
    carRevenue: "Trip revenue",
    carFuel: "Fuel",
    carMaint: "Maintenance",
    carFixed: "Fixed costs",
    ownerNet: "Net to owner",
...
function roleCaps(person) {
  ...
  const ownedCars = CARS.filter((c) => (c.ownerIds || [c.eigenaar]).includes(person.name)).map(
    (c) => c.short
  );
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      const person = PEOPLE.find(
        (p) => p.username === username.trim().toLowerCase() && p.password === password
      );
      if (!person) {
        setError(
          lang === "nl" ? "Ongeldig gebruikersnaam of wachtwoord." : "Invalid username or password."
        );
        setLoading(false);
        return;
      }
          ...
          {error && (
            <div
              style={{
                ...
                marginBottom: 14,
                padding: "8px 10px",
                border: `1px solid ${paperB.accent}`,
                background: "#fdf4f3",
              }}
            >
              {error}
        ...
        return (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              lineHeight: 1.1,
              transform: sel ? "rotate(-2deg)" : "none",
              transition: "transform 0.15s",
            }}
          >
            {p.name.slice(0, 5)}
    ...
    <div style={{ marginBottom: 10 }}>
      ...
      >
        {onChange && !readOnly ? (
          ...
          >
            {value || (
              <span style={{ color: paperB.inkMute, fontStyle: "italic" }}>{placeholder}</span>
            )}
          </div>
        )}
        {suffix && (
