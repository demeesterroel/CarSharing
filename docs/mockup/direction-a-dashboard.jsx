...
function DashGauge({ km = 128, max = 500, amount = 32.0, color = dashA.amber }) {
  const r = 110,
    cx = 140,
    cy = 140;
  ...
  return (
    <div style={{ position: "relative", width: 280, height: 160, margin: "0 auto" }}>
      <svg width="280" height="160" viewBox="0 0 280 160">
        ...
        {/* arc bg */}
        <path
          d={`M 30 140 A ${r} ${r} 0 1 1 250 140`}
          fill="none"
          stroke={dashA.border}
          strokeWidth="2"
          opacity="0.4"
        ...
        {/* arc lit */}
        <path
          d={`M 30 140 A ${r} ${r} 0 ${large} 1 ${x2} ${y2}`}
          fill="none"
      ...
      >
        ...
        >
          {km}
          <span style={{ fontSize: 16, color: dashA.textDim, marginLeft: 4 }}>km</span>
        </div>
        <div
          style={{
            fontFamily: dashA.fontDisplay,
        ...
        return (
          <div
            ...
            style={{
              ...
              textAlign: "center",
              boxShadow: active
                ? `0 0 0 3px ${carColorsA[c.id]}22, inset 0 0 20px ${carColorsA[c.id]}18`
                : "none",
            }}
          >
            <div
            ...
            <div
              style={{
                fontSize: 12,
                color: active ? dashA.text : dashA.textDim,
                marginTop: 2,
              }}
            >
              {c.name}
  ...
  return (
    <div style={{ background: dashA.bg, minHeight: "100%", paddingBottom: 100 }}>
      ...
      <div style={{ padding: "12px 0 24px" }}>
        <DashGauge km={128} max={500} amount={25.6} />
        <div
          style={{
            textAlign: "center",
            fontSize: 11,
        ...
        >
          ...
          >
            ...
            <svg width="100%" height="100%" style={{ position: "absolute", inset: 0 }}>
              <path
                d="M 0 60 Q 80 40, 160 70 T 320 50"
                stroke={dashA.textMute}
                strokeWidth="1.5"
                fill="none"
                opacity="0.5"
    ...
    <div style={{ background: dashA.bg, minHeight: "100%", paddingBottom: 100 }}>
      ...
      <div style={{ position: "relative", height: 200, margin: "0 20px", marginBottom: 20 }}>
        ...
        >
          ...
          >
            38,2<span style={{ fontSize: 18, color: dashA.textDim, marginLeft: 6 }}>L</span>
          </div>
          <div
            style={{
              position: "absolute",
          ...
          >
            TOTAAL
            <br />
            <span style={{ fontSize: 22, color: dashA.text, letterSpacing: -0.5 }}>€ 66,55</span>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div
              style={{
                flex: 1,
                height: 2,
                background: `linear-gradient(90deg, ${dashA.amber}, ${dashA.amberDim})`,
                borderRadius: 2,
                margin: "0 8px",
                position: "relative",
              }}
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              >
                <svg width="8" height="10" viewBox="0 0 8 10">
                  <path d="M6 1L2 5l4 4" stroke={dashA.textDim} strokeWidth="1.5" fill="none" />
                </svg>
              </div>
              <div
                style={{
              ...
              >
                <svg width="8" height="10" viewBox="0 0 8 10">
                  <path d="M2 1l4 4-4 4" stroke={dashA.textDim} strokeWidth="1.5" fill="none" />
                </svg>
              </div>
            </div>
          </div>
            ...
            {Array.from({ length: 21 }).map((_, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    height: 36,
                    borderRadius: isSel ? (isStart ? "8px 0 0 8px" : isEnd ? "0 8px 8px 0" : 0) : 6,
        ...
        >
          <div
            style={{
              ...
              height: 8,
              borderRadius: 4,
              background: dashA.green,
              boxShadow: `0 0 8px ${dashA.green}`,
            }}
          />
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 13, color: dashA.text, fontWeight: 500 }}>
              Ethel is vrij op deze dagen
            </div>
            <div style={{ fontSize: 11, color: dashA.textDim, marginTop: 2 }}>
