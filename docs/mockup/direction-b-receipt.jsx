  ...
  return (
    <div style={{ marginBottom: 8 }}>
      ...
      >
        ...
        {suffix && (
          <div style={{ fontFamily: paperB.fontMono, fontSize: 13, color: paperB.inkDim }}>
            {suffix}
          </div>
        )}
      </div>
      ...
      >
        ...
        >
          <svg width="100%" height="100%" style={{ position: "absolute", inset: 0 }}>
            <path
              d="M 10 50 Q 60 20, 120 40 T 250 30"
              stroke={paperB.ink}
              strokeWidth="1.2"
              fill="none"
              strokeDasharray="3 2"
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              Tik om te scannen. We lezen
              <br />
              bedrag &amp; liters automatisch.
            </div>
          </div>
        </div>
        ...
        >
          “Het geld dat je tankt staat op
          <br />
          jouw rekening — iedereen deelt eerlijk.”
        </div>

        <div style={{ textAlign: "center", padding: "6px 0" }}>
          <Stamp rotate={4} color={paperB.green}>
            In de kas
          </Stamp>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", padding: "8px 0", marginTop: 6 }}>
          <Stamp rotate={-3} color={paperB.green}>
            Beschikbaar
          </Stamp>
        </div>
      </div>
