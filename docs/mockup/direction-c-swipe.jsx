  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          €19<span style={{ fontSize: 36, fontWeight: 400 }}>,20</span>
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          <path
            d="M 0 20 Q 20 0, 40 20 T 80 20 T 120 20"
            stroke={carColorsC.ETH.ink}
            strokeWidth="2"
            fill="none"
            opacity="0.25"
          />
              ...
              style={{
                ...
                background:
                  i === 0
                    ...
                    : i === 4
                      ? swipeC.bg
                      : ["#d9f05a", "#b9d9ff", "#ffd1b5", "#d9c8ff"][i - 1],
                ...
                border:
                  i === 0
                    ? `2.5px solid ${swipeC.lime}`
                    : i === 4
                      ? `1.5px dashed ${swipeC.inkMute}`
                      : "none",
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20">
              <path
                ...
                fill="none"
              />
              <circle cx="10" cy="8" r="2" fill={swipeC.ink} />
            </svg>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 14, fontWeight: 600, color: swipeC.ink }}>
              Brugge, Grote Markt
            </div>
            <div style={{ fontSize: 12, color: swipeC.inkDim, marginTop: 2 }}>
              Huidige locatie · tik om te wijzigen
            </div>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div style={{ padding: "0 16px", display: "flex", gap: 12, marginBottom: 14 }}>
        <div
          style={{
            flex: 1,
            background: swipeC.lavender,
            borderRadius: 22,
            padding: 18,
            position: "relative",
          }}
        >
          <div style={{ fontSize: 11, fontWeight: 600, color: swipeC.ink, opacity: 0.6 }}>
            BEDRAG
          </div>
          <div
            style={{
          ...
          >
            €66<span style={{ fontSize: 24 }}>,55</span>
          </div>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            38<span style={{ fontSize: 24 }}>,2</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "0 16px", marginBottom: 14 }}>
        ...
        >
          ...
          <div style={{ fontSize: 12, color: swipeC.inkDim }}>berekend uit bedrag ÷ liters</div>
        </div>
      </div>
      ...
      <div style={{ padding: "0 16px" }}>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: swipeC.inkDim, marginTop: 2 }}>
              Jij hebt betaald · +€66,55 op jouw rekening
            </div>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div
            style={{
              padding: "5px 10px",
              borderRadius: 10,
              background: carColorsC.JF.ink,
              fontSize: 12,
              fontWeight: 600,
              color: carColorsC.JF.bg,
            }}
          >
            ✓ Vrij
          </div>
